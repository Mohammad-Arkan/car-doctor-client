...
const Banner = () => {
    return (
      ...
      <div id="slide1" className="carousel-item relative w-full">
        ...
        <div className="absolute flex items-center h-full left-0 rounded-xl bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] flex text-white  right-5 bottom-0">
          <div className='space-y-7 w-2/5 pl-20'>
      ...
      <div id="slide2" className="carousel-item relative w-full">
        ...
        <div className="absolute flex items-center rounded-xl h-full left-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] flex text-white  right-5 bottom-0">
          <div className='space-y-7 w-2/5 pl-20'>
          <h2 className='text-6xl font-bold'>Affordable Price For Car Servicing</h2>
            <p>There are many variations of passages of  available, but the majority have suffered alteration in some form</p>
            <div>
